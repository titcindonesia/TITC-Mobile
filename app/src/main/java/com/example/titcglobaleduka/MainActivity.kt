...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.settings.apply {
            ...
            userAgentString = userAgentString.replace("; wv", "") // Optimize user agent for standard mobile web rendering
        }
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
                ...
                // Load internal web app links directly within WebView
                view?.loadUrl(url)
                return true
            }
        ...
        // Set WebChromeClient for handling page loading progress
        ...
        // Handle hardware and gesture back button navigation
